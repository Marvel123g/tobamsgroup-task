...
const CorporateTraining = () => {
  return (
    <section className="bg-[#FFFFFF] py-[60px] px-[20px] sm:p-[60px] flex flex-col items-center mx-auto max-w-[1440px] gap-[24px] min-[986px]:gap-[120px]">
      <section className="flex flex-col min-[986px]:flex-row gap-[24px] min-[986px]:gap-[64px]">
        <Card
      ...
      <section className="flex flex-col-reverse min-[986px]:flex-row gap-[24px] min-[986px]:gap-[64px]">
        <img
          src="/Images/TR2.jpg"
...
function Card({
  ...
  return (
    <section className="max-w-[646px] w-full flex flex-col gap-3">
      <h1 className="text-[#151515] font-semibold text-[30px] xl:text-[35px]">{title}</h1>
      <p className="text-[#696969] text-base xl:text-lg font-normal">{description}</p>

...
const DevelopmentProgram = () => {
  ...
  return (
    <section className="p-[64px]">
      <main className="bg-[#2C0922] p-[40px] rounded-[20px] flex gap-[34px]">
        <img
          src="/Images/DP.jpg"
          alt="Development Program"
          className="rounded-[8px] max-w-[592px] h-auto text-white object-cover"
        />

        <section className="flex flex-col gap-[32px] ">
          <h1 className="text-[#FFFFFF] font-semibold text-[40px]">
          ...
          <div className="py-[8px] px-[16px] flex flex-col gap-[25px]">
            {programData.map((program, i) => (
              <p key={i} className="bg-[#8F6182] py-[6px] px-[8px] rounded-lg flex items-center gap-2">
                <svg
                  width="19"
                  height="24"
                  viewBox="0 0 19 24"

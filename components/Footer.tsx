    ...
    <footer>
      <section className="px-[20px] xl:px-[64px] py-[40px] flex flex-col min-[1000px]:flex-row justify-between items-start gap-[24px] min-[1000px]:items-center bg-[#1D0617] border-b-2 border-b-[#C4C4C4] " data-aos="zoom-in">
        <div className="space-y-3">
          ...
          <h1 className="text-[#FFFFFF] font-semibold text-xl sm:text-[32px]">
            Let’s work together to create a difference
          </h1>
        </div>
        <button className="bg-[#571244] py-[12px] px-[24px] rounded-sm text-[#FFFFFF] font-semibold text-sm sm:text-lg">
          Get In Touch
        </button>
      </section>
        ...
        <section className="py-[20px]">
          <div className="flex flex-col-reverse min-[1000px]:flex-row gap-[24px] w-full p-[24px] rounded-lg bg-[#FFFFFF0F]">
            <section className="text-[#FFFFFF] w-full flex flex-col gap-[10px]">
              ...
              <div className="grid grid-cols-1 min-[1000px]:grid-cols-[2fr_0.01fr_1.5fr] gap-[24px] text-base font-normal">
                <section>
